...
import { Examples, ParticleEngine } from '../ParticleEngine.js';
...
function main() {
	...
	loadGLTF('model/gltf/capoeira/Capoeira.gltf', [1, 0, 1], [0.01, 0.01, 0.01]).then(function(gltf){
